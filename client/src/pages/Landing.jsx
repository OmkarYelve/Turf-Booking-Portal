  ...
  return (
    <>
      ...
      <video
        ...
        preload="metadata"
      >
        <source src={turf} type="video/mp4" />
      </video>
      <div id="main" className="mt-0 pt-0">
        <div id="page1">
          ...
          <p>
            Turf's Corner is a sportsground and outdoor playground booking
            portal that provides easy booking facility. Enabling players to
            easily book a turf playground online - anytime, anywhere.
          </p>
        </div>
                ...
                <div className="flex flex-wrap -mx-4">
                  <div className="w-full px-4">
                    <div className="text-center mx-auto mb-12 lg:mb-20 max-w-[510px]">
                      <h2 className="pt-20 text-5xl text-black font-extrabold text-center">
                        {" "}
                        Why <span className="text-pink-600">Turf's Corner</span>
                      </h2>
                      <p className=" pt-10 text-black text-xl">
                        Turf zone is a sportsground and outdoor playground
                        booking portal that provides easy booking facility for
                        schools, clubs and other sports organizations across
                        Kenya. Enabling them to easily book a turf playground
                        online - anytime.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex flex-wrap pb">
                  <div className="w-full md:w-1/2 lg:w-1/3 px-6">
                    ...
                    <p className=" text-black">
                      No more calling around and being on hold for long periods
                      of time.
                    </p>
                  </div>
                  ...
                  <div className="w-full md:w-1/2 lg:w-1/3 px-4">
                    ...
                    <p className="text-black">Book a turf in advance.</p>
                  </div>
          ...
          <section className="w-full py-24">
            <div className="w-4/5 mx-auto text-center">
              ...
              <p className="mt-6 text-lg text-black">
                Turf's Corner is an app where you can book grounds to play
                football and cricket with your friends and loved ones. Book a
                ground near you today!
              </p>
            </div>
          </section>
        </div>
